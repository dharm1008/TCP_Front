  ...
  return (
    <div className="col " style={{backgroundColor: "rgb(255, 255, 255)", marginTop: "100px"}}>
            <div className="title fw-bold text-center"
                style={{backgroundColor: "#094E7F", padding: "10px", marginTop: "100px", color: "white"}}>Misuse of Land Report
            </div>
            ...
            <div className="container">
                ...
                <div className="row mb-3">
                    <div className="col-md-12">
                        <div className="mb-3 row">
                            <label for="inputPassword" className="col-sm-2 col-form-label">District<code>*</code></label>
                ...
                <div className="row mb-3">
                    <div className="col-md-12">
                        <div className="mb-3 row">
                            <label for="inputPassword" className="col-sm-2 col-form-label">Controlled Area<code>*</code></label>
                            <div className="col-sm-10">
                                <input type="text" className="form-control" id="inputPassword"/>
                            </div>
                        </div>
